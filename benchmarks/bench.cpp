...
#include "btree-google/btree_map.h"
#include "btree-google/btree_set.h"
#include "btree-google/btree_test.h"
...
void BM_Fifo(int n) {
  ...
  for (int i = 0; i < n; i++) {
    ...
    // TODO: Add insert with hint to skip_list. 
    //container.insert(container.end(), g(i + FLAGS_benchmark_values));
    container.insert(g(i + FLAGS_benchmark_values));
  }
...
typedef ease::data::skip_list::set<int32_t> sl_set_int32;
typedef ease::data::skip_list::set<int64_t> sl_set_int64;
typedef ease::data::skip_list::set<string> sl_set_string;

typedef ease::data::skip_list::map<int32_t, intptr_t> sl_map_int32;
typedef ease::data::skip_list::map<int64_t, intptr_t> sl_map_int64;
typedef ease::data::skip_list::map<string, intptr_t> sl_map_string;

typedef ease::data::skip_list::multiset<int32_t> sl_multiset_int32;
typedef ease::data::skip_list::multiset<int64_t> sl_multiset_int64;
typedef ease::data::skip_list::multiset<string> sl_multiset_string;

typedef ease::data::skip_list::multimap<int32_t, intptr_t> sl_multimap_int32;
typedef ease::data::skip_list::multimap<int64_t, intptr_t> sl_multimap_int64;
typedef ease::data::skip_list::multimap<string, intptr_t> sl_multimap_string;
...
#define MY_BENCHMARK2(type, name, func)    \
  MY_BENCHMARK4(sl_ ## type, name, func); \
